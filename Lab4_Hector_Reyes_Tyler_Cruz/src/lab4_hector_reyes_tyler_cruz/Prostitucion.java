...
public class Prostitucion extends DelitoMenor {
    ...
    public Prostitucion(String nombreSolicitante, String nombrePolicia, int idPolicia, int numCelda, String descripcion, String nombreVictima, boolean culpable, String sentencia, String fecha, int numDelito, String pais) {
